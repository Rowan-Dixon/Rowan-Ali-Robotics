...
def plot_map(prob_map, grid, path=None, points=None):
    """
    ...
    points   : array of world-coordinate points to plot (optional)
    """
    ...
    if points is not None:
        ...
        ax.scatter(points_arr[:, 0], points_arr[:, 1], c='red', s=40)
